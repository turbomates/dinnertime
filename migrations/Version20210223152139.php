 ...
 */
final class Version20210223152139 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE dishes (id UUID NOT NULL, restaurant_id UUID NOT NULL, name VARCHAR(100) NOT NULL, price DOUBLE PRECISION NOT NULL, picture VARCHAR(100) NOT NULL, weight DOUBLE PRECISION NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE restaurants (id UUID NOT NULL, name VARCHAR(100) NOT NULL, min_delivery_price DOUBLE PRECISION NOT NULL, delivery_cost DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
